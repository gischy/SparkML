...
public class LogisticRegressionTrain1_2AndTest1_5_Sample100_500_1000 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		for (int sampleSize : sampleSizes) {
			...
			// load test data
			String path2 = "C:/Users/Kirchgeorg/Desktop/desktop/testrepos/sparkml/training_data/training_musicbrainz1_5.csv";
